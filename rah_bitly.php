 ...
 *
 * Requires Textpattern v4.5 or newer.
 *
...
if(@txpinterface == 'admin') {
	...
	register_callback('rah_bitly', 'article_posted');
	register_callback('rah_bitly_partials_meta', 'article_ui', 'partials_meta');
}


/**
 * Set custom fields volatile to make them render after every article update
 *
 * @param string $event  Admin-side event
 * @param string $step	Admin-side step
 * @param array() $rs	Article data
 * @param array() $partials Partials meta data
 */
...
function rah_bitly($event, $step, $rs=array()) {
