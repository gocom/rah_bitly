...
p. Gives "Textpattern":http://www.textpattern.com CMS' articles tiny "Bitly":http://bitly.com powered short links. The links are generated automatically when an article is published and stored in a custom field of your choosing. Easy to setup, just define your credentials via graphical user interface. Adds zero more steps to article publishing. Made by "Jukka Svahn's":http://twitter.com/gocom tiny hand, using and loving Bitly.
...
p. Most servers, including shared hosting spaces, should be able to run *rah_bitly* just fine as long as Textpattern v4.5.0 or newer is installed.
...
p. "Get your own API key":http://bitly.com/a/your_api_key. Click the link to find out your own API key and username.
...
* Added: Textpattern v4.5.0 compatibility. Thank you, "Robert Wetzlmayr":https://github.com/rwetzlmayr.
