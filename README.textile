...
p. Give articles tiny "Bitly":http://bitly.com powered short links. The links are generated automatically when an article is published and stored in a custom field of your choosing. Easy to setup, just define your credentials via graphical user interface. Adds zero more steps to article publishing.

* Version: 0.3
* Updated: 2011/12/05 6:35 PM UTC
