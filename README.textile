...
* *API key* is your API key. "Request your own API key here.":http://bitly.com/a/your_api_key You can also find your API key from your Bitly account's settings page.
* *Store in custom field* is the custom field that will be used to store shortened links.

p. "Sir, what is my API key anyway?":http://bitly.com/a/your_api_key Click the link to get your own API key, or to verify your current credentials.
